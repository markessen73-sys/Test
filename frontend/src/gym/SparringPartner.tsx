...
useTexture.preload(BODY_STYLES['body-default'].textureSrc);
useTexture.preload(assetUrl('/boxer/bodies/default-ooh.png'));
useTexture.preload(assetUrl('/boxer/bodies/default-knockout.png'));

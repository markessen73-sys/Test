...
export const BODY_STYLES: Record<BodyStyleId, BodyStyle> = {
  ...
  'body-kk': body(
    ...
    // Same packing metrics as Foxy Thong / user KK source refs.
    [0.4082, 0.0215, 0.6064, 0.179],
    0.0664
  ),
  'body-bozza': body(
  ...
  'body-greenie': body(
    'body-greenie',
    'The Greenie',
    '/boxer/bodies/greenie-idle.png',
    '/boxer/bodies/greenie-idle-thumb.png',
    [0.4082, 0.0215, 0.6064, 0.179],
    0.0664
  ),
  'body-don': body(
    'body-don',
    'The Don',
    '/boxer/bodies/don-idle.png',
    '/boxer/bodies/don-idle-thumb.png',
    [0.4082, 0.0215, 0.6064, 0.179],
    0.0664
  ),
  'body-tin-mick': body(
    'body-tin-mick',
    'Tin Mick',
    '/boxer/bodies/tin-mick-idle.png',
    '/boxer/bodies/tin-mick-idle-thumb.png',
    [0.4082, 0.0215, 0.6064, 0.179],
    0.0664
  ),
  'body-default': body(
  ...
  'body-default-female': body(
    'body-default-female',
    'Default Female',
    '/boxer/bodies/default-female-idle.png',
    '/boxer/bodies/default-female-idle-thumb.png',
    [0.4082, 0.0215, 0.6064, 0.179],
    0.0664
  ),
  'body-byson': body(
  ...
  'body-king': body(
    'body-king',
    'King Of The North',
    '/boxer/bodies/king-idle.png',
    '/boxer/bodies/king-idle-thumb.png',
    [0.4082, 0.0215, 0.6064, 0.179],
    0.0664
  ),
  'body-pricey': body(
    'body-pricey',
    'Pricey',
    '/boxer/bodies/pricey-idle.png',
    '/boxer/bodies/pricey-idle-thumb.png',
    [0.4082, 0.0215, 0.6064, 0.179],
    0.0664
  ),
};
...
export const BODY_STYLE_LIST: BodyStyle[] = [
  ...
  BODY_STYLES['body-king'],
  BODY_STYLES['body-pricey'],
];
